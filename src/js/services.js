$(".btn-service").on("click", function() {
	...
	if (a[0] == 1) {
		...
		$("#servicesModal .modal-body").append('<p><strong>CarLux Detailing</strong> - це сучасна детейлінг студія із досвідом роботи понад 5 років.' +
			...
			'</p>&nbsp;</p>' +
			'<div class="fm text_box"><table align="center" border="1" cellpadding="5" cellspacing="0" dir="ltr" style="width:100%;"><colgroup><col /><col /><col /></colgroup><tbody><tr><td style="text-align: center;"><strong>Категорія авто</strong></td><td style="text-align: center;"><strong>Полірування, $</strong></td><td style="text-align: center;"><strong>Кераміка, $</strong></td></tr><tr><td style="text-align: center;">Mini</td><td style="text-align: center;">150</td><td style="text-align: center;">150</td></tr><tr><td style="text-align: center;">Sedan</td><td style="text-align: center;">180</td><td style="text-align: center;">200</td></tr><tr><td style="text-align: center;">Crossover</td><td style="text-align: center;">200</td><td style="text-align: center;">250</td></tr><tr><td style="text-align: center;">Jeep</td><td style="text-align: center;">220</td><td style="text-align: center;">300</td></tr></tbody></table></div>');
	} else if (a[0] == 2) {
		...
		$("#servicesModal .modal-body").append('<strong>Хімчистка авто|CarLux</strong> - це сучасна технологія хімчистки яка передбачає використання професійної техніки та безпечних для навколішнього серидовища хімічних засобів вироблених у Німеччині та Італії. ' +
			...
			'<p>&nbsp;</p>' +
			'<div class="fm text_box"><table align="center" border="1" cellpadding="5" cellspacing="0" dir="ltr" style="width:100%;"><colgroup><col /><col /><col /></colgroup><tbody><tr><td style="text-align: center;"><strong>Категорія авто</strong></td><td style="text-align: center;"><strong>Хімчистка Delux, грн</strong></td><td style="text-align: center;"><strong>Хімчистка Delux Premium, грн</strong></td></tr><tr><td style="text-align: center;">Mini</td><td style="text-align: center;">5000</td><td style="text-align: center;">6000</td></tr><tr><td style="text-align: center;">Sedan</td><td style="text-align: center;">6000</td><td style="text-align: center;">7000</td></tr><tr><td style="text-align: center;">Crossover</td><td style="text-align: center;">7000</td><td style="text-align: center;">8000</td></tr><tr><td style="text-align: center;">Jeep</td><td style="text-align: center;">8000</td><td style="text-align: center;">9000</td></tr></tbody></table></div>');
	} else {
