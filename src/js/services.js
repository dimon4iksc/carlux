$(".btn-service").on("click", function() {
	...
	if (a[0] == 1) {
		...
		$("#servicesModal .modal-body").append('<p><strong>CarLux Detailing</strong> - це сучасна детейлінг студія із досвідом роботи понад 5 років.' +
			...
			'</p>&nbsp;</p>' +
			'<div class="fm text_box"><table align="center" border="1" cellpadding="5" cellspacing="0" dir="ltr" style="width:100%;"><colgroup><col /><col /></colgroup><tbody><tr><td style="text-align: center;"><strong>Категорія авто</strong></td><td style="text-align: center;"><strong>Вартість, $</strong></td></tr><tr><td style="text-align: center;">Mini</td><td style="text-align: center;">150</td></tr><tr><td style="text-align: center;">Sedan</td><td style="text-align: center;">180</td></tr><tr><td style="text-align: center;">Crossover</td><td style="text-align: center;">220</td></tr><tr><td style="text-align: center;">Jeep</td><td style="text-align: center;">250</td></tr></tbody></table></div>');
	} else if (a[0] == 2) {
